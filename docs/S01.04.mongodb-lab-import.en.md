...
- Writing about the whole process

You can work solo or in groups of 2 max.

## Evaluation

Please fill in the [spreadsheet](https://docs.google.com/spreadsheets/d/1hxAfTP46o67dwY2gkeGqrvCRICEvxUKaNTtFQQNL2RE/edit?gid=0#gid=0) with a link to the dataset, and a link to the google doc that you will submit.

- Please use google doc
- invite <alexis.perrier@gmail.com> as editor

This mini project is graded.

You will have 5' to present your work on June 2nd.
- no slides needed, just screen sharing and talk
...
If (hahaha) you use LLMs to write, it's ok but please keep it short and read the text before submitting.

As the bard said:  **Brevity is the soul of Wit**

![Brevity is the soul of Wit](./../img/memes/chickenbrevity.jpg)
...
- Kaggle datasets
  - [Open Food Facts](https://www.kaggle.com/datasets/openfoodfacts/world-food-facts)
  - [Arxiv](https://www.kaggle.com/datasets/sumitm004/arxiv-scientific-research-papers-dataset/data)
  - [Disasters](https://www.kaggle.com/datasets/brsdincer/all-natural-disasters-19002021-eosdis)
...
- [ademe.fr](https://data.ademe.fr/datasets/dpe-v2-tertiaire-2)
...
Your tutorial / journal can include
