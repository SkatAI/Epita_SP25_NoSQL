...
Note: The smaller datasets (100 and 1000 samples) are available if you struggle to import the full datasets.
By default, you should try working directly with the full datasets:
